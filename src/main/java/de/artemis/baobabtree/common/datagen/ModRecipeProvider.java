    ...
    protected RecipeProvider createRecipeProvider(HolderLookup.Provider registries, RecipeOutput output) {
        return new RecipeProvider(registries, output) {
            ...
            protected void buildRecipes() {
                ...
                ShapedRecipeBuilder.shaped(itemLookup, RecipeCategory.TRANSPORTATION, ModItems.BAOBAB_BOAT.get())
                        .pattern("# #")
                        .pattern("###")
                ...
                ShapelessRecipeBuilder.shapeless(itemLookup, RecipeCategory.TRANSPORTATION, ModItems.BAOBAB_CHEST_BOAT.get())
                        .requires(ModItems.BAOBAB_BOAT.get())
                        .requires(Blocks.CHEST)
                        .unlockedBy(getHasName(ModItems.BAOBAB_BOAT.get()), has(ModItems.BAOBAB_BOAT.get()))
                        .save(this.output);

                ShapelessRecipeBuilder.shapeless(itemLookup, RecipeCategory.DECORATIONS, ModBlocks.BAOBAB_SAPLING.get())
                ...
                ShapelessRecipeBuilder.shapeless(itemLookup, RecipeCategory.DECORATIONS, ModBlocks.BAOBAB_LITTER.get(), 2)
                        .requires(ModBlocks.BAOBAB_LEAVES.get())
                        .unlockedBy(getHasName(ModBlocks.BAOBAB_LEAVES.get()), has(ModBlocks.BAOBAB_LEAVES.get()))
                        .save(this.output);

                ShapelessRecipeBuilder.shapeless(itemLookup, RecipeCategory.DECORATIONS, ModBlocks.TREE_ROOT.get())
                        .requires(Blocks.DIRT)
                        .requires(Blocks.HANGING_ROOTS)
                        .unlockedBy(getHasName(Blocks.HANGING_ROOTS), has(Blocks.HANGING_ROOTS))
                        .save(this.output);

                ShapelessRecipeBuilder.shapeless(itemLookup, RecipeCategory.DECORATIONS, Blocks.HANGING_ROOTS)
                ...
                ShapelessRecipeBuilder.shapeless(itemLookup, RecipeCategory.FOOD, ModItems.BAOBAB_FRUIT.get(), 2)
                ...
                ShapelessRecipeBuilder.shapeless(itemLookup, RecipeCategory.FOOD, ModItems.BAOBAB_FRUIT.get(), 4)
                ...
                ShapelessRecipeBuilder.shapeless(itemLookup, RecipeCategory.FOOD, ModItems.BAOBAB_FRUIT.get(), 6)
