...
<h1 align="center">Contributing to Baobab Tree</h1>

<p align="center">
  Thank you for your interest in contributing to Baobab Tree.
</p>

<p align="center">
  Contributions help improve the mod and are welcome in many forms, including bug fixes, new baobab content, world-generation improvements, compatibility improvements, code improvements, documentation changes, and other useful additions.
</p>
...
<p align="center">
  ...
  &nbsp;&nbsp;&nbsp;
  <a href="https://github.com/IntelligenceModding/BaobabTree/issues/new/choose"><img src="https://img.shields.io/badge/GitHub-Open%20an%20Issue-181717?style=for-the-badge&logo=github&logoColor=white" alt="Open a GitHub Issue"></a>
</p>
...
- [Developing Baobab Tree](#developing-baobab-tree)
  - [Testing](#testing)
...
Reporting bugs is one of the easiest ways to contribute to Baobab Tree.
...
- make sure your mod loader and required dependencies are compatible with the Baobab Tree version you are using;
...
Suggestions for new baobab content, building options, world-generation improvements, compatibility improvements, or other features are welcome.

Before creating a feature request:

- check existing issues for similar suggestions;
- explain what the feature would add to Baobab Tree;
...
Baobab Tree uses separate branches for different Minecraft versions and mod loaders.
...
Before working on Baobab Tree, make sure you have the following installed:
...
If you are contributing through a pull request, first fork the [Baobab Tree repository][repository] to your own GitHub account.

Clone your fork:

```bash
git clone https://github.com/YOUR_USERNAME/BaobabTree.git
cd BaobabTree
```
...
```bash
git remote add upstream https://github.com/IntelligenceModding/BaobabTree.git
```
...
Baobab Tree includes the Gradle wrapper, so installing Gradle separately is normally not necessary.
...
## Developing Baobab Tree

### Testing

Changes should be tested before being submitted.

There is currently no expectation that every contribution includes automated tests. For most Baobab Tree changes, practical in-game testing is more useful.
...
For changes affecting baobab blocks or items, make sure placement, orientation, harvesting, roots, litter, fruit pods, wood variants, and other supported interactions continue to behave correctly where applicable.

For changes affecting naturally generated baobab trees, fallen trees, or other world-generation features, test the result in newly generated chunks and in the relevant biomes.
...
Contributions involving textures, models, sounds, or other assets are welcome where they fit the style and purpose of Baobab Tree.
...
- keep new baobab content visually consistent with the existing wood set, roots, litter, fruit, and other assets;
...
Documentation changes should be clear, accurate, and relevant to Baobab Tree.
...
By submitting code, documentation, textures, models, sounds, or other material to Baobab Tree, you confirm that you have the right to contribute that material.

Unless explicitly agreed otherwise, contributions are made under the license used by the Baobab Tree repository.
...
[repository]: https://github.com/IntelligenceModding/BaobabTree "Baobab Tree GitHub Repository"
[new-issue]: https://github.com/IntelligenceModding/BaobabTree/issues/new/choose "Create a New Issue"
[branches]: https://github.com/IntelligenceModding/BaobabTree/branches "Baobab Tree Branches"
